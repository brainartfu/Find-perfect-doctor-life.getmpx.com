...
__( "Caching Types" ), // src/pages/caching/caching.jsx:51
__( "Caching Settings" ), // src/pages/caching/caching.jsx:69
__( "Automatic Purge" ), // src/pages/caching/caching.jsx:73
__( "Perform a smart cache purge based on events happening on your WordPress site." ), // src/pages/caching/caching.jsx:77
__( "When clearing the cache - purge the WordPress API cache too." ), // src/pages/caching/caching.jsx:95
__( "Automatic Purge Caching only works if you have Dynamic Caching enabled. To start using this feature, please enable Dynamic Caching first." ), // src/pages/caching/caching.jsx:108
__( "Automatic Purge Caching only works if you have File-based Caching enabled. To start using this feature, please enable File-based Caching first." ), // src/pages/caching/caching.jsx:119
__( "Test URL Caching Status" ), // src/pages/caching/caching.jsx:142
__( "Review the caching status of specific URLs. Use this functionality to verify whether excluded URLs are working as expected." ), // src/pages/caching/caching.jsx:148
__( "Test" ), // src/pages/caching/caching.jsx:173
__( "Exclude URLs from Caching" ), // src/pages/caching/caching.jsx:183
__( "Invalid URL" ), // src/pages/caching/caching.jsx:193
__( "Exclude Post Types from Caching" ), // src/pages/caching/caching.jsx:212
